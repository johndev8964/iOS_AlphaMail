...
class CI_DB_active_record extends CI_DB_driver {
	...
	{	
		...
		$sql = $this->_create_table($this->dbprefix.$table, $this->fields, $this->primary_keys, $this->keys, $if_not_exists);
	...
	{
		$sql = $this->_drop_table($this->dbprefix.$table_name);
	...
	function add_column($table = '', $field = array(), $after_field = '')
	{
		...
		foreach ($field as $k => $v)
		{
			...
			$sql = $this->_alter_table('ADD', $this->dbprefix.$table, $this->fields, $after_field);
	...
	function drop_column($table = '', $column_name = '')
	{
		...
		$sql = $this->_alter_table('DROP', $this->dbprefix.$table, $column_name);
	...
	function modify_column($table = '', $field = array())
	{
		...
		foreach ($field as $k => $v)
		{
			...
			$sql = $this->_alter_table('CHANGE', $this->dbprefix.$table, $this->fields);
